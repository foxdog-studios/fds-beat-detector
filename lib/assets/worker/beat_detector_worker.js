(function() {
  ...
  BeatDetector = (function() {
    var BEAT_MIN_DISTANCE_SAMPLES, MAX_BPM_DETECTED, MAX_DISTANCE_MULTIPLIER, MAX_SEARCH_WINDOW_SIZE, MINIMUM_THRESHOLD, SAMPLE_RATE;
    ...
    BeatDetector.prototype.detectBeats = function(pcmAudioData, previousEnergyVarianceCoefficient, _previousAverageEnergyCoefficient, _samplesPerInstantEnergy, _numberOfPreviousEnergies, _maxBpm) {
      ...
      this._trackLength = pcmAudioData.length / SAMPLE_RATE;
    ...
    BeatDetector.prototype._getSecondsPerInstantEnergy = function() {
      return this._samplesPerInstantEnergy / SAMPLE_RATE;
    };
  ...
  main = function() {
    return self.addEventListener('message', function(event) {
      ...
      beatDetector.detectBeats(data.pcmData, data.previousEnergyVarianceCoefficient, data.previousAverageEnergyCoefficient, data.samplesPerInstantEnergy, data.numberOfPreviousSamples, data.maxBpm);
